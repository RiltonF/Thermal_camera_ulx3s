...
CLK2_OPTIONS ?= --clkin 25 --clkout0 100 --clkout1 50 --phase1 0 --clkout2 25 --phase2 0 --clkout3 125 --phase3 0
CLK3_NAME ?= clk3
CLK3_FILE_NAME ?= $(CLOCKS_DIR)/$(CLK3_NAME).v
CLK3_OPTIONS ?= --clkin 25 --clkout0 100 --clkout1 50 --phase1 0 --clkout2 25 --phase2 0 --clkout3 125 --phase3 0
